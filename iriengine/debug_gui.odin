...
setup_imgui_style :: proc(){
	...
	style.Colors[imgui.Col.Text]                   		= imgui.Vec4{0.57, 0.53, 0.61, 1.00};
	style.Colors[imgui.Col.TextDisabled]           		= imgui.Vec4{0.42, 0.42, 0.42, 1.00};
	style.Colors[imgui.Col.WindowBg]               		= imgui.Vec4{0.10, 0.09, 0.13, 1.00};
	style.Colors[imgui.Col.ChildBg]                		= imgui.Vec4{0.13, 0.11, 0.15, 1.00};
	style.Colors[imgui.Col.PopupBg]                		= imgui.Vec4{0.13, 0.11, 0.15, 1.00};
	style.Colors[imgui.Col.Border]                 		= imgui.Vec4{0.17, 0.15, 0.21, 0.62};
	style.Colors[imgui.Col.BorderShadow]           		= imgui.Vec4{0.00, 0.00, 0.00, 0.00};
	style.Colors[imgui.Col.FrameBg]                		= imgui.Vec4{0.19, 0.17, 0.23, 1.00};
	style.Colors[imgui.Col.FrameBgHovered]         		= imgui.Vec4{0.42, 0.20, 0.36, 1.00};
	style.Colors[imgui.Col.FrameBgActive]          		= imgui.Vec4{0.46, 0.12, 0.34, 1.00};
	style.Colors[imgui.Col.TitleBg]                		= imgui.Vec4{0.23, 0.13, 0.20, 1.00};
	style.Colors[imgui.Col.TitleBgActive]          		= imgui.Vec4{0.34, 0.20, 0.30, 1.00};
	style.Colors[imgui.Col.TitleBgCollapsed]       		= imgui.Vec4{0.00, 0.00, 0.00, 0.51};
	style.Colors[imgui.Col.MenuBarBg]              		= imgui.Vec4{0.23, 0.14, 0.20, 1.00};
	style.Colors[imgui.Col.ScrollbarBg]            		= imgui.Vec4{0.00, 0.00, 0.00, 0.00};
	style.Colors[imgui.Col.ScrollbarGrab]          		= imgui.Vec4{0.22, 0.19, 0.25, 1.00};
	style.Colors[imgui.Col.ScrollbarGrabHovered]   		= imgui.Vec4{0.45, 0.12, 0.33, 1.00};
	style.Colors[imgui.Col.ScrollbarGrabActive]    		= imgui.Vec4{0.62, 0.14, 0.35, 1.00};
	style.Colors[imgui.Col.CheckMark]              		= imgui.Vec4{0.57, 0.53, 0.61, 1.00};
	style.Colors[imgui.Col.SliderGrab]             		= imgui.Vec4{0.49, 0.42, 0.53, 1.00};
	style.Colors[imgui.Col.SliderGrabActive]       		= imgui.Vec4{0.64, 0.38, 0.53, 1.00};
	style.Colors[imgui.Col.Button]                 		= imgui.Vec4{0.20, 0.16, 0.23, 1.00};
	style.Colors[imgui.Col.ButtonHovered]          		= imgui.Vec4{0.42, 0.20, 0.36, 1.00};
	style.Colors[imgui.Col.ButtonActive]           		= imgui.Vec4{0.46, 0.12, 0.34, 1.00};
	style.Colors[imgui.Col.Header]                 		= imgui.Vec4{0.25, 0.21, 0.29, 1.00};
	style.Colors[imgui.Col.HeaderHovered]          		= imgui.Vec4{0.50, 0.23, 0.37, 1.00};
	style.Colors[imgui.Col.HeaderActive]           		= imgui.Vec4{0.57, 0.19, 0.40, 1.00};
	style.Colors[imgui.Col.Separator]              		= imgui.Vec4{0.33, 0.29, 0.36, 1.00};
	style.Colors[imgui.Col.SeparatorHovered]       		= imgui.Vec4{0.45, 0.12, 0.33, 1.00};
	style.Colors[imgui.Col.SeparatorActive]        		= imgui.Vec4{0.62, 0.14, 0.35, 1.00};
	style.Colors[imgui.Col.ResizeGrip]             		= imgui.Vec4{0.37, 0.31, 0.38, 1.00};
	style.Colors[imgui.Col.ResizeGripHovered]      		= imgui.Vec4{0.45, 0.12, 0.33, 1.00};
	style.Colors[imgui.Col.ResizeGripActive]       		= imgui.Vec4{0.62, 0.14, 0.35, 1.00};
	style.Colors[imgui.Col.TabHovered]             		= imgui.Vec4{0.55, 0.11, 0.36, 1.00};
	style.Colors[imgui.Col.Tab]                    		= imgui.Vec4{0.29, 0.15, 0.22, 1.00};
	style.Colors[imgui.Col.TabSelected]            		= imgui.Vec4{0.38, 0.10, 0.22, 1.00};
	style.Colors[imgui.Col.TabSelectedOverline]    		= imgui.Vec4{0.62, 0.14, 0.35, 1.00};
	style.Colors[imgui.Col.TabDimmed]              		= imgui.Vec4{0.34, 0.16, 0.26, 1.00};
	style.Colors[imgui.Col.TabDimmedSelected]      		= imgui.Vec4{0.36, 0.17, 0.26, 1.00};
	style.Colors[imgui.Col.TabDimmedSelectedOverline] 	= imgui.Vec4{0.50, 0.50, 0.50, 0.00};
	style.Colors[imgui.Col.DockingPreview]         		= imgui.Vec4{0.67, 0.38, 0.54, 0.64};
	style.Colors[imgui.Col.DockingEmptyBg]         		= imgui.Vec4{0.28, 0.04, 0.20, 1.00};
	style.Colors[imgui.Col.PlotLines]              		= imgui.Vec4{0.65, 0.28, 0.28, 1.00};
	style.Colors[imgui.Col.PlotLinesHovered]       		= imgui.Vec4{1.00, 0.43, 0.35, 1.00};
	style.Colors[imgui.Col.PlotHistogram]          		= imgui.Vec4{0.16, 0.35, 0.57, 1.00};
	style.Colors[imgui.Col.PlotHistogramHovered]   		= imgui.Vec4{1.00, 0.60, 0.00, 1.00};
	style.Colors[imgui.Col.TableHeaderBg]          		= imgui.Vec4{0.23, 0.13, 0.20, 1.00};
	style.Colors[imgui.Col.TableBorderStrong]      		= imgui.Vec4{0.16, 0.15, 0.19, 1.00};
	style.Colors[imgui.Col.TableBorderLight]       		= imgui.Vec4{0.23, 0.21, 0.24, 1.00};
	style.Colors[imgui.Col.TableRowBg]             		= imgui.Vec4{0.00, 0.00, 0.00, 0.00};
